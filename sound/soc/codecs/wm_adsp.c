					      ...
					      struct device *dev)
{
	...
	return firmware_reject_nowarn(firmware, filename, dev);
}
					 ...
					 const char *filetype)
{
	...
	if (system_name && asoc_component_prefix)
		fw->filename = kasprintf(GFP_KERNEL, "/*(DEBLOBBED)*/", dir, dsp->part,
		...
		fw->filename = kasprintf(GFP_KERNEL, "/*(DEBLOBBED)*/", dir, dsp->part, fwf,
