...
static int cs40l50_reset_dsp(struct cs40l50 *cs40l50)
{
	...
	ret = cs_dsp_power_up(&cs40l50->dsp, cs40l50->fw, "/*(DEBLOBBED)*/",
			      cs40l50->bin, "/*(DEBLOBBED)*/", "cs40l50");
	if (ret)
		goto err_mutex;
...
static void cs40l50_request_firmware(const struct firmware *fw, void *context)
{
	...
	ret = reject_firmware_nowait(THIS_MODULE, FW_ACTION_UEVENT, CS40L50_WT,
...
int cs40l50_probe(struct cs40l50 *cs40l50)
{
	...
	ret = reject_firmware_nowait(THIS_MODULE, FW_ACTION_UEVENT, CS40L50_FW,
