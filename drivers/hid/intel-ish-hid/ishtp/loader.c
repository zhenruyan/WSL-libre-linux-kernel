 ...
 *   Occurs when `reject_firmware()` cannot locate the firmware image. The ISH firmware will
...
#define ISH_FW_FILE_VENDOR_FAMILY_NAME_SKU_FMT "/*(DEBLOBBED)*/"
#define ISH_FW_FILE_VENDOR_FAMILY_SKU_FMT "/*(DEBLOBBED)*/"
#define ISH_FW_FILE_VENDOR_FAMILY_NAME_FMT "/*(DEBLOBBED)*/"
#define ISH_FW_FILE_VENDOR_FAMILY_FMT "/*(DEBLOBBED)*/"

#define ISH_FW_FILE_VENDOR_NAME_SKU_FMT "/*(DEBLOBBED)*/"
#define ISH_FW_FILE_VENDOR_SKU_FMT "/*(DEBLOBBED)*/"
#define ISH_FW_FILE_VENDOR_NAME_FMT "/*(DEBLOBBED)*/"
#define ISH_FW_FILE_VENDOR_FMT "/*(DEBLOBBED)*/"
#define ISH_FW_FILE_DEFAULT_FMT "/*(DEBLOBBED)*/"
					...
					const char *name, struct device *dev)
{
	...
	ret = firmware_reject_nowarn(firmware_p, name, dev);
	if (!ret)
