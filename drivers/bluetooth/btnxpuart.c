...
#define FIRMWARE_W8987		"/*(DEBLOBBED)*/"
#define FIRMWARE_W8987_OLD	"/*(DEBLOBBED)*/"
#define FIRMWARE_W8997		"/*(DEBLOBBED)*/"
#define FIRMWARE_W8997_OLD	"/*(DEBLOBBED)*/"
#define FIRMWARE_W9098		"/*(DEBLOBBED)*/"
#define FIRMWARE_W9098_OLD	"/*(DEBLOBBED)*/"
#define FIRMWARE_IW416		"/*(DEBLOBBED)*/"
#define FIRMWARE_IW416_OLD	"/*(DEBLOBBED)*/"
#define FIRMWARE_IW612		"/*(DEBLOBBED)*/"
#define FIRMWARE_IW610		"/*(DEBLOBBED)*/"
#define FIRMWARE_SECURE_IW610	"/*(DEBLOBBED)*/"
#define FIRMWARE_IW624		"/*(DEBLOBBED)*/"
#define FIRMWARE_SECURE_IW624	"/*(DEBLOBBED)*/"
#define FIRMWARE_AW693		"/*(DEBLOBBED)*/"
#define FIRMWARE_SECURE_AW693	"/*(DEBLOBBED)*/"
#define FIRMWARE_AW693_A1		"/*(DEBLOBBED)*/"
#define FIRMWARE_SECURE_AW693_A1	"/*(DEBLOBBED)*/"
#define FIRMWARE_HELPER		"/*(DEBLOBBED)*/"
	...
	if (!strlen(nxpdev->fw_name)) {
		if (strcmp(fw_name, FIRMWARE_HELPER) &&
		    !device_property_read_string(&nxpdev->serdev->dev,
						 ...
						 &fw_name_dt))
			fw_name = fw_name_dt;
		snprintf(nxpdev->fw_name, MAX_FW_FILE_NAME_LEN, "/*(DEBLOBBED)*/", fw_name);
		err = reject_firmware_direct(&nxpdev->fw, nxpdev->fw_name, &hdev->dev);
		if (err < 0 && fw_name_old) {
			snprintf(nxpdev->fw_name, MAX_FW_FILE_NAME_LEN, "/*(DEBLOBBED)*/", fw_name_old);
			err = reject_firmware_direct(&nxpdev->fw, nxpdev->fw_name, &hdev->dev);
		}
