...
#define IWL_DR_A_PE_A_FW_PRE		"/*(DEBLOBBED)*/"
#define IWL_BR_A_PET_A_FW_PRE		"/*(DEBLOBBED)*/"
#define IWL_BR_A_PE_A_FW_PRE		"/*(DEBLOBBED)*/"

#define IWL_DR_A_PE_A_FW_MODULE_FIRMWARE(api) \
	IWL_DR_A_PE_A_FW_PRE /*(DEBLOBBED)*/
#define IWL_BR_A_PET_A_FW_MODULE_FIRMWARE(api) \
	IWL_BR_A_PET_A_FW_PRE /*(DEBLOBBED)*/
#define IWL_BR_A_PE_A_FW_MODULE_FIRMWARE(api) \
	IWL_BR_A_PE_A_FW_PRE /*(DEBLOBBED)*/
