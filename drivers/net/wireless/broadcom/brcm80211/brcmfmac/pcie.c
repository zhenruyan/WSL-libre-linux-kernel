...
BRCMF_FW_CLM_DEF(4355, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4355C1, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4356, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(43570, "/*(DEBLOBBED)*/");
BRCMF_FW_DEF(4358, "/*(DEBLOBBED)*/");
BRCMF_FW_DEF(4359, "/*(DEBLOBBED)*/");
BRCMF_FW_DEF(4359C, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4364B2, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4364B3, "/*(DEBLOBBED)*/");
...
BRCMF_FW_CLM_DEF(43752, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4377B3, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4378B1, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4378B3, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4387C2, "/*(DEBLOBBED)*/");
