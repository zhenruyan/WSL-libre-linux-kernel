...
BRCMF_FW_CLM_DEF(43430A1, "/*(DEBLOBBED)*/");
BRCMF_FW_DEF(43430B0, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(43439, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(43455, "/*(DEBLOBBED)*/");
BRCMF_FW_DEF(43456, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4354, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4356, "/*(DEBLOBBED)*/");
BRCMF_FW_DEF(4359, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(4373, "/*(DEBLOBBED)*/");
BRCMF_FW_CLM_DEF(43012, "/*(DEBLOBBED)*/");
