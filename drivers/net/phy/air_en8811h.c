...
#define EN8811H_MD32_DM		"/*(DEBLOBBED)*/"
#define EN8811H_MD32_DSP	"/*(DEBLOBBED)*/"
#define AN8811HB_MD32_DM	"/*(DEBLOBBED)*/"
#define AN8811HB_MD32_DSP	"/*(DEBLOBBED)*/"
			      ...
			      u32 address)
{
	...
	ret = reject_firmware_direct(&fw, name, dev);
	if (ret < 0)
		return ret;
...
static int en8811h_load_firmware(struct phy_device *phydev)
{
	...
	ret = reject_firmware_direct(&fw1, EN8811H_MD32_DM, dev);
	if (ret < 0)
		return ret;

	ret = reject_firmware_direct(&fw2, EN8811H_MD32_DSP, dev);
	if (ret < 0)
