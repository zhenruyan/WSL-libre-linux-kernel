...
static inline int
firmware_reject_nowait_nowarn(struct module *module,
			      const char *name, struct device *device,
					   ...
					   void *context))
{
	...
	return firmware_request_nowait_nowarn(module, NONFREE_FIRMWARE,
					      device, gfp, context, cont);
}
static inline int
maybe_firmware_reject_nowait_nowarn(struct module *module,
				    const char *name, struct device *device,
				    gfp_t gfp, void *context,
				    void (*cont)(const struct firmware *fw,
						 void *context))
{
	if (is_nonfree_firmware(name))
		return firmware_reject_nowait_nowarn(module, name, device,
						     gfp, context, cont);
	else
...
static inline int
reject_firmware_nowait(struct module *module, bool uevent,
		       const char *name, struct device *device,
		       gfp_t gfp, void *context,
		       void (*cont)(const struct firmware *fw,
				    void *context))
...
static inline void
reject_firmware_nowait_cancel(struct device *device, void *context,
			      void (*cont)(const struct firmware *fw,
					   void *context))
{
	return request_firmware_nowait_cancel(device, context, cont);
}
static inline int
maybe_reject_firmware_nowait(struct module *module, bool uevent,
			     const char *name, struct device *device,
			     gfp_t gfp, void *context,
			     void (*cont)(const struct firmware *fw,
					  void *context))
...
static inline void
maybe_reject_firmware_nowait_cancel(struct device *device, void *context,
				    void (*cont)(const struct firmware *fw,
						 void *context))
{
	return request_firmware_nowait_cancel(device, context, cont);
